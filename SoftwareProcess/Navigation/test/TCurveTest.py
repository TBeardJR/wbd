...
#        n -> numeric mandatory validated
#        f -> instance method mandatory validated
#     outputs
#        float
# Happy path
#     integrate constant from 0 to 1
#     integrate u from 0 to 1
#     integrate u^2 from 0 to 1
#     integrate 5.32*(u/0.23) from 0 to 10
#     integrate self.f from 0 to 15
#
# Sad path
#     None. t, n, f are all pre-validated

    def test500_010_ShouldIntegrate_Constant_UpperBound_1(self):
        myT = T.TCurve(self.nominalN)
        t = 1.0
        def f(u, n):
            return 100
        self.assertAlmostEquals(myT.integrate(t, myT.n, f), 100, 2)
        
    def test500_020_ShouldIntegrate_U_UpperBound_1(self):
        myT = T.TCurve(self.nominalN)
        t = 1.0
        def f(u, n):
            return u
        self.assertAlmostEquals(myT.integrate(t, myT.n, f), 0.5, 2)
        
    def test500_030_ShouldIntegrate_USquared_UpperBound_1(self):
        myT = T.TCurve(self.nominalN)
        t = 1.0
        def f(u, n):
            return u**2
        self.assertAlmostEquals(myT.integrate(t, myT.n, f), 0.33, 2)
        
    def test500_040_ShouldIntegrate_Function_UpperBound_10(self):
        myT = T.TCurve(self.nominalN)
        t = 10.0
        def f(u, n):
            return 5.32*(u/0.23)
        self.assertAlmostEquals(myT.integrate(t, myT.n, f), 1156.52, 2)
        
    def test500_040_ShouldIntegrate_Original_Function_UpperBound_15(self):
        myT = T.TCurve(self.nominalN)
        t = 15.0
        self.assertAlmostEquals(myT.integrate(t, myT.n, myT.f), 1.33, 2)
